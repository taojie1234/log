...
// SetLogger provides a given logger adapter into BeeLogger with conf string.
// conf need to be correct JSON as string: {"interval":360}.
...
func formatLog(f interface{}, v ...interface{}) string {
	...
	// 添加goroutineid
	return fmt.Sprintf("%d " /*goroutine.GoroutineId()*/, 0) + fmt.Sprintf(msg, v...)
}
